#!/usr/bin/env bash
# OrvixPanel v0.7.4 production installer.
#
# Idempotent — re-run safely. Targets Ubuntu 22.04+ / 24.04+ with systemd.
# On non-systemd environments (e.g. WSL without [boot] systemd=true) the
# script prints a clear fallback at the end.
#
# What this does:
...
green ""
green "==========================================="
green "OrvixPanel v0.7.4 installed."
